...
- I code in either [Neovim](https://neovim.io) using [NvChad](https://github.com/NvChad/NvChad) config, in [gVim](https://www.vim.org) when doing assembly, or in [VSCode](https://code.visualstudio.com)/[JetBrains](https://www.jetbrains.com/) when doing C#/C/C++/TS.
